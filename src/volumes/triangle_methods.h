...
public:
    CUDA_HOST_DEVICE static bool Hit(const Ray&, const Vector3*, const Vector3*, const Vector3*, double, double, HitResult&);
private:
    CUDA_HOST_DEVICE static bool Intersects(const Ray&, const Vector3*, const Vector3*, const Vector3*, double &, double& , double &);
    CUDA_HOST_DEVICE static bool Intersects2(const Ray&, const Vector3*, const Vector3*, const Vector3*, double &, double&, double &);
};
